angular.module('starter.controllers', ['ngStorage', 'ngCookies', 'ngCordova', 'starter.utils'])
  ...
  .controller('FeedPartyCtrl', function ($scope, FeedParty, Parties) {
    $scope.parties = Parties.query(function () {
      var partiesHash = {};
      angular.forEach($scope.parties, function (party) {
        partiesHash[party.id] = party;
      });
      $scope.feedData = FeedParty.query(function () {
        angular.forEach($scope.feedData, function (feedItem) {
          feedItem.taggedParties = feedItem.to ? feedItem.to.map(function (t) {
            return t ? partiesHash[t.substr(6)] : null;
          }) : [];
        });
      });
    });
  ...
  .controller('FeedFlatCtrl', function ($scope, FeedFlat, Parties) {
    $scope.parties = Parties.query(function () {
      var partiesHash = {};
      angular.forEach($scope.parties, function (party) {
        partiesHash[party.id] = party;
      });
      $scope.feedData = FeedFlat.query(function () {
        angular.forEach($scope.feedData, function (feedItem) {
          feedItem.taggedParties = feedItem.to ? feedItem.to.map(function (t) {
            return t ? partiesHash[t.substr(6)] : null;
          }) : [];
  ...
  .controller('FeedUserCtrl', function ($scope, $sessionStorage, Parties, FeedUser) {
    $scope.parties = Parties.query(function () {
      ...
      $scope.feedData = FeedUser.query(function () {
        angular.forEach($scope.feedData, function (feedItem) {
          feedItem.taggedParties = feedItem.to ? feedItem.to.map(function (t) {
            return t ? partiesHash[t.substr(6)] : null;
          }) : [];
