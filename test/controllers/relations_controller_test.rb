...
class RelationsControllerTest < ActionController::TestCase
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post :create, relation: { fbuser_id: @relation.fbuser_id, friend_fbuser_id: @relation.friend_fbuser_id }
    end
  ...
  test "should update relation" do
    patch :update, id: @relation, relation: { fbuser_id: @relation.fbuser_id, friend_fbuser_id: @relation.friend_fbuser_id }
    assert_redirected_to relation_path(assigns(:relation))
  end
